...
void process10HzTask1() {
  ...
  Serial.print(throttle);
  Serial.print(" altitudeHoldState=");
  Serial.println(altitudeHoldState);
   */
}
...
void process1HzTask() {
    ...
    sendSerialHeartbeat();   
         ...
         Serial.print(readWaypointLF.latitude);
         Serial.print(',');
         Serial.println(readWaypointLF.longitude);
     #endif       
